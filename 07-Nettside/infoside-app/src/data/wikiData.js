...
<div style="background: var(--bg-secondary); border: 1px solid var(--border-color); border-left: 4px solid var(--accent-color); border-radius: 4px 12px 12px 4px; padding: 20px; margin-top: 16px;">
  ...
  <p style="margin: 0; line-height: 1.6; color: var(--text-secondary);">
    ...
    "tldr": [
      "Syntax & Flow bygger på det eksisterende emnet <strong>ITD35014 Bedriftspraksis (10 stp)</strong> ved Høgskolen i Østfold.",
      "Organisasjonen drives av en stabil kjerne (veiledere/forelesere), mens studenter utfører de kommersielle pro-bono oppdragene.",
      "Business casen er en helhetlig modell der Value Proposition (VPC) og de juridiske tilpasningene henger tett sammen."
    ]
  },
  {
    "id": "fremdrift",
    "title": "Fremdrift & Sammenheng",
    "category": "Oversikt",
    "icon": "TrendingUp",
    "lead": "Oversikt over fremdrift og hvordan de ulike delene av Syntax & Flows Business Case henger sammen.",
    "sections": [
      {
  ...
  },
  {
    ...
    "tldr": [
      "Visjonen er å fjerne 'erfaringsgapet' for nyutdannede ved å gi dem relevant prosjekterfaring i studietiden.",
      "Tverrfaglige team samler studenter fra IT/utvikling, UI/UX/design og økonomi/forretningsutvikling.",
      "Målet er å skape verdi for studenter (erfaring), bedrifter (risikofri verdi) og HiØ (akademisk relevans)."
    ]
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Daglig leder</strong>",
              "Fast / lønnet (eller frivillig med stipend)",
              "Daglig drift, kundekontakt, strategi"
            ],
            [
              "<strong>Fagansvarlige (IT, design, økonomi)</strong>",
              "Fast / lønnet (eller HiØ-ansatte på deltid)",
              "Faglig kvalitetssikring, veiledning, oppdragsvurdering"
            ],
            [
              "<strong>Forelesere (HiØ-ansatte)</strong>",
              "Trukket inn ved behov for ekspertise",
              "Kvalitetssikring av komplekse leveranser, faglig rådgivning"
            ],
            [
              "<strong>Styret</strong>",
              "Uavhengige medlemmer + HiØ-observatør",
              "Strategisk retning, tilsyn, nettverk"
            ]
          ]
        },
        "isCollapsible": true
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Teammedlem</strong>",
              "ITD35014 (10 stp)",
              "Utfører oppgaver i tverrfaglige team under veiledning"
            ],
            [
              "<strong>Teamleder</strong>",
              "ITD35014 + erfarent medlem",
              "Koordinerer teamet, holder kundekontakt, rapporterer til fagansvarlig"
            ]
          ]
        },
      ...
      },
      {
        ...
        "gridCards": [
          {
            "title": "ITD35014 Bedriftspraksis",
            "subtitle": "10 studiepoeng (valgfritt emne)",
            "icon": "BookOpen",
            "content": "<strong>Målgruppe:</strong> Bachelorstudenter (IT/Design/Økonomi) som har bestått min. 90 stp.<br/><strong>Finansiering:</strong> Ordinær utdanningsstøtte. Inngår i bachelorløp på 30 stp per semester (full Lånekassestøtte). Lånekassens minstekrav på 15 stp gjelder kun ved enkeltemnestudier."
          },
          {
            "title": "NAV-samarbeid",
            "subtitle": "Individuell tiltaksplan (Utsatt)",
            "icon": "Users",
            "content": "<strong>Målgruppe:</strong> Personer utenfor arbeidsmarkedet med IT/Design/Økonomi-bakgrunn.<br/><strong>Status:</strong> Utsettes til etter piloten (tidligst Fase 4). Tiltakspenger/dagpenger dekket av NAV."
          }
        ]
      },
      {
    ...
    "tldr": [
      "Tydelig driftsskille: Den stabile driftskjernen (administrasjon/forelesere) sikrer kvalitet, mens studenter utfører oppdragene.",
      "Deltakelsen skjer gjennom ordinært emne (ITD35014) på 10 stp (Spor 1), med mål om utvidelse til 15–30 stp over tid.",
      "NAV-samarbeid (Spor 3) er utsatt til etter pilotfasen for å unngå administrativ overload."
    ]
  },
  {
    "id": "ordliste",
    ...
    "tldr": [
      "En alfabetisk oppslagsbase over faguttrykk, juridiske begreper og økonomiske forkortelser som brukes i prosjektet.",
      "Inneholder forklaringer på alt fra statsstøtteregler (de minimis) til markedsføringsuttrykk (CAC, Churn, CLTV)."
    ]
  },
  {
    ...
    "sections": [
        ...
        "table": {
          ...
          "rows": [
            [
              ...
              "Være en selvstendig organisasjon in-house på HiØ som gir studenter en klar bane fra utdanning til fast ansatt, gjennom eksterne oppdrag og interne evighetsprosjekter",
              "Være et kommersielt konsulentbyrå som konkurrerer med etablerte aktører"
            ],
            [
              "<strong>Drift av S&F</strong>",
              "En stabil kjerne (daglig leder, fagansvarlige, forelesere ved behov) som sikrer kontinuitet og kvalitet uavhengig av studentutskifting",
              "Studentene driver organisasjonen"
            ],
            [
              "<strong>Studentens rolle</strong>",
              "Utfører oppdragene i tverrfaglige team under veiledning — mottaker av tilbudet",
              "Må selv skaffe praksisplass hos eksterne bedrifter"
            ],
            [
              "<strong>Foreleserens rolle</strong>",
              "Trukket inn ved behov for faglig ekspertise og kvalitetssikring",
              "Daglig drift eller detaljstyring av studentene"
            ],
            [
              "<strong>Sted</strong>",
              "In-house på HiØ med tilgang til foreleseres ekspertise",
              "Fysisk utenfor campus uten faglig oppfølging"
            ]
          ]
        }
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Eksterne oppdrag</strong>",
              "Enkle nettsider, landingssider, logo/visuell profil, markedsanalyser og forretningsmodellering (BMC)",
              "Avanserte apper med sensitive databaser, IT-sikkerhetsrevisjon, systemintegrasjoner (ERP/CRM)"
            ],
            [
              "<strong>Interne prosjekter</strong>",
              "Langsiktige evighetsprosjekter som går over flere semestre med fokus på systemarkitektur, database og API",
              "Kortsiktige ad-hoc-oppgaver uten dokumentasjon eller langsiktig verdi"
            ],
            [
              "<strong>Kvalitetssikring</strong>",
              "Veiledning og godkjenning av leveranser av faglige mentorer (HiØ-forelesere) før overlevering",
              "Levere løsninger direkte til kunden uten faglig kvalitetssikring"
            ],
            [
              "<strong>Portefølje</strong>",
              "Dokumentasjon av prosjektet og publisering av anonymiserte case-studier på portalen (med samtykke)",
              "Publisere detaljert kode eller bedriftsdata uten skriftlig samtykke"
            ]
          ]
        }
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Prioritet 1 & 2</strong>",
              "Interne avdelinger ved Høgskolen i Østfold, samt lokale ideelle organisasjoner, idrettslag og frivillighet",
              "Bedrifter med mer enn 5 ansatte eller med egne utviklingsbudsjetter"
            ],
            [
              "<strong>Prioritet 3 & 4</strong>",
              "Etablerere/privatpersoner (ENK uten ansatte) og lokale mikrovirksomheter (1-5 ansatte) uten budsjett",
              "Offentlige anbudskonkurranser og etablerte selskaper med kommersiell kapasitet"
            ],
            [
      ...
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Studieemne</strong>",
              "Bruke det eksisterende emnet ITD35014 Bedriftspraksis (10 stp) som formell ramme",
              "Søke om å opprette helt nye emner før piloten er fullført"
            ],
            [
              "<strong>Lånekassestøtte</strong>",
              "Utvide ITD35014 til 15–30 stp på sikt for å sikre Lånekassestøtte",
              "Kombinere med urealistiske 5 stp-emner som ikke finnes ved HiØ"
            ],
            [
              "<strong>Deltakelse i dag</strong>",
              "Tilby ITD35014 (10 stp) som eneste alternativ for studenter i pilotfasen",
              "Forvente Lånekassestøtte for 10 stp enkeltemne"
            ],
            [
              "<strong>NAV-samarbeid</strong>",
              "Utsette NAV-samarbeidet til etter pilotfasen (tidligst Fase 4)",
              "Rekruttere NAV-deltakere uten separate avtaler fra dag én"
            ]
          ]
        }
      },
        ...
        "table": {
          ...
          "rows": [
            [
              ...
              "Brukerreiser, klikkbare Figma-prototyper, designsystemer og brukervennlighetstesting",
              "Ad-hoc grafisk produksjon uten forankring i brukerinnsikt"
            ],
            [
              "<strong>Økonomi</strong>",
              "Budsjettering, prosjektkalkyler, kostnadsanalyser og gevinstrealiseringsplaner for systemene",
              "Ekstern regnskapsføring eller regnskapsrevisjon for andre bedrifter"
            ],
            [
              "<strong>Dataingeniør</strong>",
              "Systemarkitektur, databaseoppsett (Supabase/Postgres), backend og API-er",
              "Systemintegrasjon mot eksterne kommersielle databaser med personopplysninger"
            ],
            [
              "<strong>Informasjonssystemer</strong>",
              "Sikkerhetstesting, kvalitetssikring, integrasjonstester og intern IT-revisjon av systemene",
              "Utføre IT-sikkerhetsrevisjon for eksterne bedrifter"
            ]
          ]
        }
      }
        ...
        "gridCards": [
          {
            ...
            "icon": "LineChart",
            "content": "Kartlegging av forretningsmodell, flaskehalsanalyse, regnskapsoppsett (Fiken/Tripletex), og markedsanalyser."
          },
          {
            "title": "UI/UX & Design",
            "icon": "Palette",
            "content": "Visuell profil (logo, farger), wireframes, klikkbare Figma-prototyper og brukervennlighetstester."
          },
          {
            "title": "IT & Webutvikling",
            "icon": "Code2",
            "content": "Nettsider/landingssider (React, Next.js, WordPress), MVP-prototyping og digitalisering/CRM-oppsett."
          }
        ]
      },
      {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "<strong>Vanlig praksis (Internship)</strong>",
              "Etablerte rammer, gir studiepoeng",
              "Begrenset antall plasser, lite tverrfaglighet, kunden må selv veilede",
              "Vi leverer ferdige tverrfaglige team og tar oss av prosjektledelsen"
            ],
            [
              "<strong>Frilansarbeid</strong>",
              "Studenten tjener penger direkte, fleksibelt",
              "Studenten står alene uten veiledning, høy risiko for prosjekthavari",
              "Vi tilbyr et trygt rammeverk med faglige mentorer (forelesere)"
            ],
            [
              "<strong>Kommersielle byråer</strong>",
              "Svært høy kvalitet, erfarne konsulenter",
              "Ekstremt dyrt for småbedrifter og oppstartsbedrifter",
              "Vi leverer gratis til de som uansett ikke har råd til profesjonelle byråer"
            ]
          ]
        }
      },
    ...
    "tldr": [
      "Målgruppen er primært lokale mikrovirksomheter (< 5 ansatte) og gründere i Østfold som uansett ikke har budsjett til kommersielle byråer.",
      "Dette valget forhindrer klager om urettferdig priskonkurranse eller markedsforstyrrelse fra etablerte aktører.",
      "Markedspotensialet er stort på grunn av høye timepriser i kommersielle byråer og manglende brobyggere i regionen."
    ]
  },
  {
    "id": "risiko-og-jus",
      ...
      },
      {
        ...
        "table": {
          "headers": [
            ...
            "K (1-5)",
            "R (S×K)",
            "Forebyggende tiltak (Mitigation)"
          ],
          "rows": [
            [
              "<strong>Studenter faller fra underveis</strong>",
              "4",
              "2",
              "8",
              "Lav konsekvens pga. standardavtale: Kunden er informert om at det ikke foreligger noen leveransegaranti."
            ],
            [
              "<strong>Kunden engasjerer seg ikke</strong>",
              "3",
              "4",
              "12",
            ...
            [
              ...
              "3",
              "6",
              "Faglig mentor (HiØ-foreleser) går gjennom og godkjenner sluttproduktet før det kan overleveres."
            ],
            [
              "<strong>Juridisk ansvar for feil i kode/råd</strong>",
              "1",
              "4",
              "4",
              "Tydelig ansvarsfraskrivelse i kontrakten som signeres før oppstart. Tjenestene leveres 'som de er'."
            ]
          ]
        }
      }
    ...
    "legalTopics": [
      {
        ...
        "sources": [
          {
            "name": "Lov om utdanningsstøtte § 4",
            "url": "https://lovdata.no/lov/2005-06-03-37"
          },
          {
            "name": "Forskrift om utdanningsstøtte",
            "url": "https://lovdata.no/forskrift/2014-12-19-1742"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Arbeidsmarkedsloven § 12",
            "url": "https://lovdata.no/lov/2004-12-10-76"
          },
          {
            "name": "Forskrift om arbeidsrettede tiltak",
            "url": "https://lovdata.no/forskrift/2015-12-11-1598"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Konkurranseloven § 11 (Misbruk av dom. stilling)",
            "url": "https://lovdata.no/lov/2004-03-05-12"
          },
          {
            "name": "Markedsføringsloven § 6 (God forretningsskikk)",
            "url": "https://lovdata.no/lov/2009-01-09-2"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "EØS-avtalen Artikkel 61(1)",
            "url": "https://lovdata.no/traktat/1992-05-02-1"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Arbeidsmiljøloven § 1-8 (Arbeidstakerbegrepet)",
            "url": "https://lovdata.no/lov/2005-06-17-62"
          },
          {
            "name": "Høyesterettspraksis (Rt. 2013 s. 1024)",
            "url": "https://lovdata.no/avgjorelse/hr-2013-1255-a"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Skatteloven § 2-30 (Skattefrie institusjoner)",
            "url": "https://lovdata.no/lov/1999-03-26-14"
          },
          {
            "name": "Merverdiavgiftsloven § 3-1 (Avgiftsplikt)",
            "url": "https://lovdata.no/lov/2009-06-19-58"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Aksjeloven § 1-1 (Ansvarsbegrensning)",
            "url": "https://lovdata.no/lov/1997-06-13-44"
          },
          {
            "name": "Stiftelsesloven § 2 (Opprettelse)",
            "url": "https://lovdata.no/lov/2001-06-15-59"
          }
        ],
        "details": [
          {
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Avtaleloven § 36 (Urimelige avtaler)",
            "url": "https://lovdata.no/lov/1918-05-31-4"
          }
        ],
        "details": [
          {
            "heading": "8.1 Ansvarsfraskrivelse i pro-bono oppdrag",
            "text": "Avtalerettens utgangspunkt er avtalefrihet. Vi kan avtale at tjenestene leveres uten noen form for garanti for funksjonalitet, feil eller økonomiske konsekvenser. Avtaleloven § 36 kan sensurere urimelige klausuler, men overfor næringsdrivende kunder i en gratis tjeneste vil ansvarsfraskrivelsen normalt stå seg sterkt."
          }
        ]
      },
      {
        ...
        "sources": [
          {
            "name": "Personopplysningsloven § 1 (GDPR)",
      ...
      },
      {
        ...
        "sources": [
          {
            "name": "Universitets- og høyskoleloven",
            "url": "https://lovdata.no/lov/2005-04-01-15"
          }
        ],
        "details": [
          {
            ...
            "table": {
              ...
              "rows": [
                [
                  "Omdømmetap ved feilet prosjekt",
                  "Middels",
                  "Betydelig lokalt"
                ],
                [
                  "Statsstøtte-granskning fra ESA",
                  "Lav til middels",
                  "Kan tvinge frem modellendring"
                ],
                [
                  "Lånekassen-avslag for enkeltemner",
                  "Lav til middels",
                  "Alvorlig for studentene"
                ],
                [
                  "Erstatningskrav fra tredjepart",
                  "Lav",
                  "Kan trekke inn høgskolen"
                ]
              ]
            }
          },
    ...
    "tldr": [
      "Statsstøtte (EØS art. 61) er den største juridiske risikoen og løses ved å prise HiØs bidrag til markedspris eller definere det som undervisning.",
      "Lånekassestøtte beholdes fullt av programstudenter (30 stp), mens enkeltemnestudenter (10 stp) må ta sideemner for å nå 15 stp-grensen.",
      "Ansvarsrisiko begrenses via stiftelse av et AS og en kundeavtale med fire lag beskyttelse (ansvarsfraskrivelse, maks 10k tak)."
    ]
  },
  {
        ...
        "table": {
          ...
          "rows": [
            [
              "Status",
              "Uavklart",
              "<strong>AS eid av ideell stiftelse</strong>"
            ]
          ]
        },
        "subAdjustments": [
    ...
    "prioritizedTasks": {
      ...
      "rows": [
        [
          "1",
          "Stift AS eid av ideell stiftelse",
          "Org.form",
          "30 000–40 000 kr"
        ],
        [
          "2",
          "Utarbeid emnebeskrivelse (30 stp) med læringsmål",
          "Lånekassen",
          "Gratis"
        ],
        [
          "3",
          "Utred utvidelse av ITD35014 til 15–30 stp",
          "Lånekassen",
          "Gratis"
        ],
        [
          "4",
          "Inngå samarbeidsavtale HiØ med markedspris",
          "Statsstøtte",
          "20 000–50 000 kr"
        ],
        [
          "5",
          "Søk forhåndsuttalelse Lånekassen",
          "Lånekassen",
          "Gratis"
        ],
        [
          "6",
          "Tegn ansvarsforsikring",
          "Ansvar",
          "5 000–15 000 kr/år"
        ],
        [
          "7",
          "Utarbeid standard kundeavtale + studentavtale",
          "Ansvar/arbeidstaker",
          "10 000–20 000 kr"
        ],
        [
        ...
        [
          "9",
          "Etabler støtteregister (de minimis)",
          "Statsstøtte",
          "1 dag"
        ],
        [
          "10",
          "Utsett NAV-samarbeidet til fase 4",
          "NAV",
          "—"
        ]
      ]
    ...
    "tldr": [
      "Tre grep løser de fleste utfordringer: Stift et AS, betal HiØ markedspris for ressurser, og ha et formelt emne med læringsmål.",
      "Det foreslås 9 konkrete tilpasningsområder for å navigere trygt innenfor dagens lover uten behov for lovendringer.",
      "Prioritert tiltaksliste viser rekkefølgen av etablering fra AS-stiftelse til løpende de minimis-registerføring."
    ]
  },
  {
    ...
    "sections": [
      {
        ...
        "table": {
          "headers": [
            "Fase",
            "Fokusområde",
            "Risikoer som løses i denne fasen",
            "Prinsipp"
          ],
          "rows": [
            [
      ...
      },
      {
        ...
        "table": {
          "headers": [
            ...
            "Hvorfor",
            "Hvem",
            "Kostnad / Avhengigheter"
          ],
          "rows": [
            [
              "Kartlegg eksisterende emner ved HiØ (ITD35014)",
              "Unngå å opprette nye emner unødvendig. Bruk eksisterende mal.",
              "Studenter, studieveileder",
              "Gratis / Ingen"
            ],
            [
              "Identifiser forkjempere ved HiØ (dekaner, programledere)",
              "Sikre intern akademisk forankring og mentorressurser.",
              "Studenter (initiativtakere)",
              "Gratis / Ingen"
            ],
            [
            ...
            [
              "Forbered 1-pagers konseptskisse",
              "Gi alle interessenter samme informasjonsgrunnlag uten forpliktelser.",
              "Studenter",
              "Gratis / Ingen"
            ]
          ]
      ...
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "Stift Syntax & Flow AS eid av en ideell stiftelse",
              "Kritisk for statsstøtte: Sikrer juridisk skille fra HiØ. AS gir ansvarsbegrensning.",
              "Stiftere",
              "30 000 kr (aksjekapital) + stiftelseskostnad"
            ],
            [
              "Utarbeid formell emnebeskrivelse for Bedriftspraksis",
              "Lånekassen krever reelle læringsmål, ikke bare arbeid. Avverger også arbeidstakerstatus.",
              "HiØ programansvarlige",
              "Gratis / Utkast opprettet"
            ],
            [
              "Søk forhåndsuttalelse fra Lånekassen for emne etter grad",
              "Sikre studentenes finansiering. Gjør-eller-dø-punkt.",
              "HiØ studieadmin",
              "Gratis / Avventer emnegodkjenning"
            ],
            [
              "Inngå skriftlig samarbeidsavtale HiØ og Syntax & Flow AS",
              "Kritisk for statsstøtte: HiØ prises til markedspris for mentortimer/leie av lokaler.",
              "HiØ-jurister, styret",
              "Juristbistand / Prioritert tiltak"
            ],
            [
              "Tegn yrkesansvarsforsikring for Syntax & Flow AS",
              "Beskytte studentene personlig mot erstatningskrav ved feil i levert kode.",
              "Styreleder",
              "5 000–15 000 kr/år"
            ],
            [
              "Utarbeid standard kundeavtale med fire lag beskyttelse",
              "Ansvarsfraskrivelse ('as-is'), begrensning på maks 10k, erklæring fra kunde.",
              "Jurist, studenter",
              "10 000–20 000 kr / Utkast opprettet"
            ]
          ]
        },
        "isCollapsible": true
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "Rekrutter 3–5 studenter til pilot-team",
              "Etablere første operative team (minst 1 IT, 1 design, 1 økonomi).",
              "Studentleder",
              "Gratis / Lånekassestøtte godkjent"
            ],
            [
              "Finn én pilotkunde (lokal mikrovirksomhet < 5 ansatte)",
              "Kontrollert risiko. Enkelt oppdrag (f.eks. landingpage eller logo).",
              "Studentleder, næringsforening",
              "Gratis / Ingen kommersiell konkurranse"
            ],
            [
              "Dokumenter ALT (timer, roller, mentortid, de minimis)",
              "Dokumentasjon er bevis i eventuell ESA- eller Lånekassen-tilsyn.",
              "Hele teamet",
              "Gratis / Løpende arbeid"
            ],
            [
              "Evaluer piloten og mål faktisk statsstøtteverdi",
              "Lærdom før skalering. Sikre at verdi holder seg under de minimis-grensen.",
              "Økonomistudent, mentor",
              "Gratis / Fullført prosjekt"
            ]
          ]
        },
        "isCollapsible": true
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "Rekrutter 2–3 nye team parallelt",
              "Skalere kapasiteten gradvis (ikke hopp fra 1 til 10 kunder direkte).",
              "Studentleder",
              "Løpende / Erfaring fra pilot"
            ],
            [
              "Bygg og lanser referanseportalen (nettsiden)",
              "Sikre digital portefølje- og referansebase for studentene.",
              "IT- og designstudenter",
              "Gratis / GDPR-samtykke på plass"
            ],
            [
              "Forbered 'defense pack' mot konkurranseklager",
              "Når klagen fra kommersielle byråer kommer, må svaret ligge klart.",
              "Styret, studentleder",
              "Gratis / Dokumenter fra Fase 2 & 3"
            ],
            [
              "Start NAV-samarbeidet forsiktig med én deltaker",
              "NAV-deltakere har andre regler. Start med én for å lære systemet.",
              "NAV, studentleder",
              "Gratis / Separat avtaleverk klart"
            ]
          ]
        },
        "isCollapsible": true
      },
      {
        ...
        "table": {
          ...
          "rows": [
            ...
            [
              "<strong>ESA-klage eller granskning</strong>",
              "Svar innen fristen (2-4 uker). Bruk defense pack (samarbeidsavtale med markedspris, de minimis-register). Ikke kommenter offentlig uten godkjenning.",
              "Styret + HiØ-jurister"
            ],
            [
              "<strong>Lånekassen endrer eller avslår regler</strong>",
              "Vurder å flytte emnet Bedriftspraksis inn i graden som valgfag siste semester (30 stp). Alternativt rekrutter studenter med rest-støttetid.",
              "Studieutvalget + S&F-ledelsen"
            ],
            [
              "<strong>GDPR-brudd / datalekkasje</strong>",
              "Stopp lekkasjen umiddelbart. Varsle DPO innen 24 timer, og Datatilsynet innen 72 timer. Informer berørte studenter/kunder.",
              "DPO / Daglig leder"
            ]
          ]
        },
  ...
  },
  {
    ...
    "tldr": [
      "Studentene følger en fast uke-til-uke prosess fra uke 1 til uke 16 i semesteret.",
      "Faser: Avklaring/kontrakt (uke 1-2) -> Innsikt/design (uke 3-6) -> Utvikling (uke 7-12) -> QA (uke 13-14) -> Overlevering (uke 15-16).",
      "Metodikken sikrer at studentene lærer smidig prosjektarbeid med kontinuerlig mentorveiledning."
    ]
  },
  {
    "id": "rekruttering",
  ...
  },
  {
    ...
    "tldr": [
      "En samling av ferdige juridiske, administrative og pedagogiske maler og utkast etablert i prosjektet.",
      "Malene er kategorisert etter viktighet: Kritiske (K), Viktige (V) og Nyttige (N) for sikker og profesjonell drift."
    ]
  },
  {
    ...
    "sections": [
        ...
        "table": {
          ...
          "rows": [
            [
              ...
              "CV-er er selvrapporterte og kan være pyntet på. Vanskelig å verifisere reelt nivå.",
              "Dokumentert og verifisert arbeidshistorikk fra reelle prosjekter."
            ],
            [
              "<strong>Intervjuer</strong>",
              "Et kort møte (45-60 min) gir et overfladisk inntrykk. Lav korrelasjon med jobbprestasjon.",
              "Observasjon av kandidaten over en periode på 3–6 måneder."
            ],
            [
              "<strong>Referansesjekk</strong>",
              "Tidligere arbeidsgivere er forsiktige og gir sjelden nyanserte eller negative opplysninger.",
              "Strukturerte, objektive poengvurderinger basert på faktiske leveranser."
            ],
            [
              "<strong>Feilansettelse</strong>",
              "Å ansette feil person koster anslagsvis 1–3 ganger årslønn.",
              "Risikofri 'test-run' der kunden kjenner kandidatens kompetanse før ansettelse."
            ]
          ]
        }
      },
      {
        ...
        "table": {
          "headers": [
            "Faktor",
            "Tradisjonell ansettelsesprosess",
            "Syntax & Flow-modellen"
          ],
          "rows": [
            [
              "<strong>Varighet på test</strong>",
              "45-60 minutter intervju",
              "3–6 måneders aktivt prosjektsamarbeid"
            ],
            [
              "<strong>Datagrunnlag</strong>",
              "Søknadsbrev og CV",
              "Faktiske nettsider, Figmaskisser og markedsrapporter på portalen"
            ],
            [
              "<strong>Kostnad</strong>",
              "Headhunter koster 20-30% av årslønn. Annonsering er dyrt.",
              "Gratis (betales med tidsinvestering i prosjektet)"
            ],
            [
              "<strong>Kvalitetsgaranti</strong>",
              "Ingen, karakterer sier lite om team-evner",
              "Verifisert historikk kvalitetssikret av HiØ-mentorer"
            ]
          ]
        }
      },
      {
        ...
        "table": {
          "headers": [
            "Vurderingstype",
            "Klassifisering under GDPR",
            "Rettslig krav / Forbehold"
          ],
          "rows": [
            [
              "<strong>Strukturerte kriterier</strong> (1-5 på samarbeid, faglig nivå)",
              "Alminnelige personopplysninger",
              "Krever klart behandlingsgrunnlag. Bør baseres på **frivillig samtykke** (art. 6 nr. 1(a))."
            ],
            [
              "<strong>Fritekstkommentarer</strong> (negative påstander)",
              "Svært inngripende for studentens karriere",
              "<strong>Bør unngås helt.</strong> Høy risiko for uriktighet, ærekrenkelse og krav om sletting."
            ],
            [
              "<strong>Helse/fraværsdata</strong>",
              "Særlige kategorier av personopplysninger (art. 9)",
              "<strong>Strengt forbudt</strong> å behandle på portalen uten eksplisitte samtykke- og sikkerhetsvilkår."
            ]
          ]
        }
      },
      {
        ...
        "table": {
          "headers": [
            "Rettighet",
            "GDPR Artikkel",
            "Funksjonelt krav i portalen"
          ],
          "rows": [
            [
              "<strong>Innsynsrett</strong>",
              "Artikkel 15",
              "Studenten skal ha full tilgang til å se alle vurderinger og logger lagret om seg selv."
            ],
            [
              "<strong>Sletterett (Right to be forgotten)</strong>",
              "Artikkel 17",
              "Studenten kan når som helst kreve profil og vurderinger slettet (utføres innen 30 dager)."
            ],
            [
              "<strong>Rettingsrett</strong>",
              "Artikkel 16",
              "Studenten kan kreve at uriktige eller villedende opplysninger rettes umiddelbart."
            ],
            [
              "<strong>Begrensningsrett</strong>",
              "Artikkel 18",
              "Mulighet for studenten til å skjule profilen midlertidig dersom det oppstår tvist om en vurdering."
            ]
          ]
        }
      },
      {
        ...
        "table": {
          "headers": [
            "Faktor",
            "Tradisjonell referanse",
            "Syntax & Flow-portal"
          ],
          "rows": [
            [
              "<strong>Mottaker</strong>",
              "Sendes til én spesifikk potensiell arbeidsgiver av gangen",
              "Synlig for alle godkjente bedrifter registrert i portalen"
            ],
            [
              "<strong>Konfidensialitet</strong>",
              "Høy grad av konfidensialitet (muntlig samtale)",
              "Elektronisk lagret og tilgjengelig i database"
            ],
            [
              "<strong>Rettslig grunnlag</strong>",
              "Ulovfestet sedvane, unntatt taushetsplikt",
              "Skriftlig avtalt samtykke etter GDPR"
            ],
            [
              "<strong>Studentens status</strong>",
              "Arbeidstaker (vernet av arbeidsmiljøloven)",
              "Student under utdanning (krever kompensatoriske rettigheter i portalen)"
            ]
          ]
        }
      },
      {
        ...
        "table": {
          "headers": [
            "Kriterium",
            "Nivå 1-2 (Tilstrekkelig / God)",
            "Nivå 3-4 (Selvstendig / Meget god)",
            "Nivå 5 (Fremragende)"
          ],
          "rows": [
            [
              "<strong>Faglig kompetanse</strong>",
              "Kunne utføre enkle oppgaver under veiledning",
              "Selvstendig i kjente oppgaver og nye områder",
              "Ekspertnivå. Har veiledet andre i teamet."
            ],
            [
              "<strong>Samarbeid</strong>",
              "Fungerte i teamet, men bidro i liten grad selvstendig",
              "God lagspiller som bidrar aktivt til teamdynamikken",
              "Løftet hele teamet og løste interne utfordringer."
            ],
            [
              "<strong>Kommunikasjon</strong>",
              "Kommuniserte greit, men trengte støtte ved kundemøter",
              "Tydelig og presis kommunikasjon tilpasset mottakeren",
              "Fremragende formidlingsevne og forhandlingsteknikk."
            ],
            [
              "<strong>Gjennomføring</strong>",
              "Leverte oppgaver etter purring eller noe forsinket",
              "Leverte oppgaver til avtalt tid med god kvalitet",
              "Ekstraordinær planlegging og leveranse før fristen."
            ],
            [
              "<strong>Kundeforståelse</strong>",
              "Forsto kundens behov etter grundig forklaring",
              "Forsto og tolket behovene til funksjonelle krav",
              "Identifiserte underliggende behov og overgikk forventninger."
            ]
          ]
        }
      },
  ...
  },
  {
    ...
    "sections": [
      {
        ...
        "gridCards": [
          {
            "title": "TÅRNET — Universitetet i Oslo (UiO)",
            "subtitle": "Institutt for Informatikk (IFI), UiO",
            "icon": "Building",
            "content": "<strong>Hva:</strong> Studentdrevet IT-konsulentvirksomhet der studenter utfører programvareutviklingsoppdrag for eksterne kunder.<br/><strong>Organisering:</strong> Studentstyrt, forankret i instituttet med faglig veiledning.<br/><strong>Status:</strong> Nedlagt (viktig lærdom om kontinuitet og finansiering)."
          },
          {
            "title": "AppLab — Universitetet i Bergen (UiB)",
            "subtitle": "Institutt for Informatikk, UiB",
            "icon": "Layers",
            "content": "<strong>Hva:</strong> Studentdrevet app-utviklingslab der studenter designer og utvikler mobilapplikasjoner for reelle kunder.<br/><strong>Organisering:</strong> Startet som prosjekt innen informatikk. Tverrfaglige team med tett veiledning.<br/><strong>Status:</strong> Nedlagt."
          },
          {
            "title": "Nabla — NTNU",
            "subtitle": "NTNU Fysikk og Matematikk",
            "icon": "Activity",
            "content": "<strong>Hva:</strong> Linjeforening med bedriftskontakt (Bedkom) som formidler kontakt mellom studenter og næringsliv.<br/><strong>Organisering:</strong> Rent studentstyrt og frivillig forening.<br/><strong>URL:</strong> <a href=\"https://nabla.no\" target=\"_blank\">nabla.no</a>"
          }
        ]
      },
      {
        "heading": "2. Praksisemner med eksterne oppdrag",
        "text": "Modeller for prosjektfag forankret i studieplanen:",
        "isCollapsible": true,
        "gridCards": [
          {
            "title": "IT2901 — NTNU",
            "subtitle": "Informatikk prosjektarbeid II (15 stp)",
            "icon": "BookOpen",
            "content": "<strong>Nivå:</strong> Bachelor.<br/><strong>Hva:</strong> Grupper på 5–7 studenter utfører programvareprosjekt for ekstern kunde. Dekker hele livssyklusen.<br/><strong>URL:</strong> <a href=\"https://www.ntnu.edu/studies/courses/IT2901\" target=\"_blank\">kursinfo</a>"
          },
          {
            "title": "TDT4290 — NTNU",
            "subtitle": "Kundestyrt prosjekt (15 stp)",
            "icon": "Users",
            "content": "<strong>Nivå:</strong> Master (4. år).<br/><strong>Hva:</strong> Grupper på 6–8 mottar oppdrag fra eksterne kunder. Har standard IPR-avtale mellom bedrift og student.<br/><strong>URL:</strong> <a href=\"https://www.ntnu.edu/studies/courses/TDT4290\" target=\"_blank\">kursinfo</a>"
          },
          {
            "title": "IN2000 — UiO",
            "subtitle": "Software Engineering (20 stp)",
            "icon": "Cpu",
            "content": "<strong>Nivå:</strong> Bachelor.<br/><strong>Hva:</strong> Omfattende systemutviklingsprosjekt i team. Kunder kan være eksterne. Stort volum (250 studenter/sem).<br/><strong>URL:</strong> <a href=\"https://www.uio.no/studier/emner/matnat/ifi/IN2000/\" target=\"_blank\">kursinfo</a>"
          },
          {
            "title": "IT1901 — NTNU",
            "subtitle": "Informatikk prosjektarbeid I (7.5 stp)",
            "icon": "Code",
            "content": "<strong>Nivå:</strong> Bachelor.<br/><strong>Hva:</strong> Introduksjon til smidig applikasjonsutvikling i team. Kodekvalitet, testing, versjonskontroll.<br/><strong>URL:</strong> <a href=\"https://www.ntnu.edu/studies/courses/IT1901\" target=\"_blank\">kursinfo</a>"
          }
        ]
      },
      {
        ...
        "gridCards": [
          {
            "title": "UE Studentbedrift (nasjonalt)",
            "subtitle": "Ungt Entreprenørskap",
            "icon": "Briefcase",
            "content": "<strong>Hva:</strong> Studenter etablerer og driver reelle studentbedrifter som del av utdanningen.<br/><strong>Verdi:</strong> Leverer ferdige maler for forretningsplan, IPR og konflikthåndtering.<br/><strong>URL:</strong> <a href=\"https://www.ue.no\" target=\"_blank\">ue.no</a>"
          }
        ]
      },
      {
        ...
        "gridCards": [
          {
            "title": "Start NTNU (Brobygger)",
            "subtitle": "Frivillig organisasjon",
            "icon": "Compass",
            "content": "<strong>Hva:</strong> Studentdrevet organisasjon for innovasjon og entreprenørskap. Workshops, konkurranser og bedriftskontakt.<br/><strong>URL:</strong> <a href=\"https://startntnu.no\" target=\"_blank\">startntnu.no</a>"
          },
          {
            "title": "UiO Growth House & NTNU Nyskaping",
            "subtitle": "Studentinkubatorer",
            "icon": "Lightbulb",
            "content": "<strong>Hva:</strong> Innovasjonssentre som støtter studenter og forskere med kontorplasser, mentorskap og finansieringshjelp.<br/><strong>URL:</strong> <a href=\"https://www.ntnu.no/nyskaping\" target=\"_blank\">NTNU Nyskaping</a>"
          }
        ]
      },
      {
    ...
    "tldr": [
      "Det finnes flere lignende prosjekter i Norge, som TÅRNET (UiO, IT-konsulenthus) og IT2901 (NTNU, 15 stp praksisemne).",
      "Lærdom 1: Emneforankring i studieplanen er det eneste som gir langsiktig stabilitet og finansieringssikkerhet.",
      "Lærdom 2: En standardavtale for IPR (som NTNUs TDT4290) og tverrfaglige team er kritiske suksessfaktorer."
    ]
  }
];
